  ...
  return (
    <div className="container p-8 md:px-16 space-y-4">
      ...
      <p className="max-w-2xl mx-auto text-center md:text-xl">
        Yarsa Tech thrives with the contribution of our team. We are grateful
        towards everyone for their continued support to achieve our vision.
      </p>
